...
class Repository
{
    ...
    public function changePublicationLocale($publicationId, $oldLocale, $newLocale)
    {
        ...
        foreach ($authors as $author) {
            ...
            } else if (ContributorType::ORGANIZATION->getName() && !$author->getOrganizationName($newLocale)) {
                $author->setOrganizationName($author->ggetOrganizationName($oldLocale), $newLocale);
            }
